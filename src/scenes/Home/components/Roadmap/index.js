                               ...
                               <div className="timeline">
                                   <div className="roadmap-list row">
                                       <div className="roadmap-list-item wow fadeInRight wowed animated col-sm-6 col-sm-offset-6" data-wow-duration="1s" data-wow-delay="0.5s">
                                            ...
                                            <p>
                                            Asset managers and owners want a better way to raise money. Extend assets into a tradable strucutre.  Pre-purchase now at a discount.</p>
                                       ...
                                       <div className="roadmap-list-item wow fadeInRight wowed animated  col-sm-6 col-sm-offset-6" data-wow-duration="1s" data-wow-delay="0.5s">
                                            ...
                                            <p>Enticing the world's best developers to foster the growth and ensure the security of RealSafe is the mission of the RealSafe Foundation which will be established and supported by the .5% per year minting of new RealSafe coins.</p>
                                           <div className="history-separator-l"> </div>
                                       </div>
                                       <div className="roadmap-list-item-l wow fadeInLeft wowed animated col-sm-6" data-wow-duration="1s" data-wow-delay="0.5s">
