...
let advisors = [
    ...
    },
    {
        name: 'Zeev',
        office: 'Advisor',
        bio: 'Zeev Kirsh is currently working as an attorney and opportunity strategist in the blockchain and fintech world. He consults on Token Generation and Issuance, Smart Contract Design, Securities Laws and Regs, Compliance, Entity Formation, & Venture Negotiation. He attended Stuyvesant High School, studied Math and Biology at SUNY Stonybrook and Law & Economics at Columbia Law School. Zeev also enjoys reading about high tech and basic scientific research constantly as a daily news diet and occasionally writing about developing trends in science , engineering and futurist topics. He also thru-hiked the Appalachian trail in 2003.  Here is an article he published about bitcoin in January 2013. http://transhumanity.net/transhumanism-and-money/',
